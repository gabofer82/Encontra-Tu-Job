 ...
 */
function ponerAnho(){
    var anho = document.getElementById("anhoNac2");//tomamos el elemento anhoNac.
...
function ponerMes(){
    var mes = document.getElementById("mesNac2");//tomamos el elemento
...
function ponerDias(){
    var anho = document.getElementById("anhoNac2");//tomamos el elemento año
    var mes = document.getElementById("mesNac2");//el mes
    var dias = document.getElementById("diaNac2");//y el dia
